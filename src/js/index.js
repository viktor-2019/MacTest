  ...
  let objectForJoke = jokeRes(url).then(response => {
    ...
    res => {
      ...
      emptyHeart.addEventListener('click', () => { 
        ...
        let movedCard = document.querySelector('.right-side');
        cardJoke.style.marginTop = "20px";
        cardJoke.style.backgroundColor = "#ffffff";
        cardJoke.style.width = "90%";
        cardJoke.style.marginLeft = "5%";
        movedCard.prepend(cardJoke);
      });
